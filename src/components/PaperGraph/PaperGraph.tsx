...
const Graph = ({ data }: any) => {
  ...
  //         .forceLink(data.links)
  //         .id((d) => d.id)
  //         .distance(40) // Increase distance if needed
  //         .strength(1), // Lower the strength to allow more flexibility
  //     )
          ...
          nodeTooltip={({ node }) => {
            ...
            return (
              ...
              >
                ...
                >
                  <Text css={{ mr: '$5' }}>Year:</Text>
                  <Text color={node.color}>{node.data.year}</Text>
                </Box>
                <Box
                  css={{
                    padding: '3px 0',
